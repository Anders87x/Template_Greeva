    ...
    CalendarApp.prototype.init = function() {
        ...
        this.$saveCategoryBtn.on('click', function(){
            ...
            if (categoryName !== null && categoryName.length != 0) {
                $this.$extEvents.append('<div class="external-event bg-' + categoryColor + '" data-class="bg-' + categoryColor + '" style="position: relative;"><i class="mdi mdi-checkbox-blank-circle ml-2 vertical-middle"></i>' + categoryName + '</div>')
                $this.enableDrag();
            }
